        ...
        <div className="catg-card">
          <Link to="/products">
            <div className="overlay-grid">
              <div className="circle center background bg-baseblue"></div>
              <div className="center center-flex-column white content">
                <h3 className="fs-2">Racquets</h3>
                <p className="txt-s">Starting at Rs. 1245</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/products">
            <div className="overlay-grid">
              ...
              <div className="center center-flex-column white content">
                ...
                <p className="txt-s">Starting at Rs. 1200</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/products">
            <div className="overlay-grid">
              ...
              <div className="center center-flex-column white content">
                ...
                <p className="txt-s">Starting at Rs. 999</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <Link to="/products">
            <div className="overlay-grid">
              ...
              <div className="center center-flex-column white content">
                ...
                <p className="txt-s">Starting at Rs. 1545</p>
              </div>
            </div>
          </Link>
        </div>
